...
PUSH_VAPID_PUBLIC_KEY = get_secret("PUSH_VAPID_PUBLIC_KEY")
PUSH_VAPID_PRIVATE_KEY = get_secret("PUSH_VAPID_PRIVATE_KEY")

STRIPE_SECRET_KEY = get_secret("STRIPE_SECRET_KEY")
STRIPE_WEBHOOK_SECRET = get_secret("STRIPE_WEBHOOK_SECRET")
STRIPE_PRO_PRICE_ID = get_secret("STRIPE_PRO_PRICE_ID")
STRIPE_CAREER_HUNTER_PRICE_ID = get_secret("STRIPE_CAREER_HUNTER_PRICE_ID")
STRIPE_OFFER_ACCELERATOR_PRICE_ID = get_secret("STRIPE_OFFER_ACCELERATOR_PRICE_ID")
